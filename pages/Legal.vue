<template>
	<div>
		...
		<ul>
			...
			<li>
				<strong>Website</strong> refers to paramartor, accessible from
				<a
					href="https://dazzling-mestorf-7ab66c.netlify.app/"
					rel="external nofollow noopener"
					target="_blank"
					>https://dazzling-mestorf-7ab66c.netlify.app/</a
				>
			</li>
		</ul>
		<h2>Disclaimer</h2>
		...
		<p>
			...
			<a href="https://www.termsfeed.com/blog/sample-disclaimer-template/" target="_blank"
		...
		<h2>Cookies</h2>
		<p>We use cookies. Deal with it (or leave this website).</p>
		<h2>Data Privacy</h2>
		<p>
			The technology used may collect any of your internet browsing-related data. The terms,
			privacy policy, and other legal information of netlify certainly apply:
		</p>
		<ul>
			<li>https://www.netlify.com/privacy/</li>
			<li>https://www.netlify.com/legal/terms-of-use</li>
			<li>https://www.netlify.com/gdpr-ccpa</li>
			<li>https://www.netlify.com/dmca</li>
		</ul>
		<p>The website owner does not sell your data.</p>
		<h2>Contact Us</h2>
		...
		<ul>
			<li>
				...
				<a
					href="https://dazzling-mestorf-7ab66c.netlify.app/contactme"
					rel="external nofollow noopener"
					target="_blank"
					>https://dazzling-mestorf-7ab66c.netlify.app/contactme</a
				>
			</li>
		</ul>
	</div>
